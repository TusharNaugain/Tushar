...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed='-.1' className="main relative flex mt-[20vw] md:mt-0 items-start justify-between h-[80vh] bg-slate-200  overflow-hidden " style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}>
      <div className='flex font-founders text-[20vw] md:text-[5vw]  md:leading-[5vw] m-[5vw]'> AT BUZZ
        
      </div>
          <div className=" flex flex-col gap-10 m-[5vw] ">
            <FramerMagnetic>
              <svg id="Layer_2" height="50" width="50" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.5 58" className=" fill-[#c8bdb0] transition-colors duration-200 cursor-pointer hover:fill-[#ec4e39]">
            ...
            <FramerMagnetic>
              <svg id="Layer_2" height="50" width="50" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.13 46.08" className=" fill-[#c8bdb0] transition-colors duration-200 cursor-pointer hover:fill-[#ec4e39]">
            ...
            <FramerMagnetic>
              <svg id="Layer_2" height="50" width="50" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51.1 36.69" className=" fill-[#c8bdb0] transition-colors duration-200 cursor-pointer hover:fill-[#ec4e39]">
